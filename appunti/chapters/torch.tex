        ...
        \begin{minipage}{.9\textwidth}
            \begin{tcolorbox}[
                ...
                \begin{algorithm}[H]
                    ...
                    \begin{algorithmic}[1]
                        \For{$n$ epoche}
                            \State \texttt{dividi dataset in batch}
                            \For{\texttt{every batch}}
                                \For{\texttt{every sample}}
                                    \State \texttt{valutazione del modello}
                                    \State \texttt{calcolo della loss}
                                    \State \texttt{gradient backpropagation}
                                \EndFor
                                \State \texttt{update del modello}
                            \EndFor
                        \EndFor
                    \end{algorithmic}
                \end{algorithm}
